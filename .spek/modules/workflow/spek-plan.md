...
1. **Establish the goal.** If an argument was passed to this command, that is the goal. Otherwise read `.spek/SESSION.md`; if it has no goal, infer from the conversation. Ask only if the goal is still unclear.
